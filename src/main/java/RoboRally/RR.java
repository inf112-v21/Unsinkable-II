 ...
 */
public class RR extends InputAdapter implements ApplicationListener {
    ...
    public void create() {
        ...
        TextureRegion[][] textures = TextureRegion.split(new Texture("Robots/RobotsV1.png"), TILE_SIZE, TILE_SIZE);
