...
public enum SpecialProgramCards {
    /** Take one energy cube, and place it on your RoboRally.game.player mat. */
    ENERGY_ROUTINE,
     ...
     * If your previous register was a damage card, draw a card from the top of your RoboRally.game.deck,
    ...
    public static List<SpecialProgramCards> ALL_SPECIAL_CARDS = Arrays.asList(
