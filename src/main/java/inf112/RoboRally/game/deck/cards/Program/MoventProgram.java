...
public enum MoventProgram {
     ...
     * draw a card from the top of your inf112.RoboRally.game.deck, and play that card this register.If you used an upgrade in
    ...
    public static List<MoventProgram> ALL_MOVEMENT_CARDS = Arrays.asList(
