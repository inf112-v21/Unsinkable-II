...
public enum TemporaryUpgrade {
     ...
     * It is now permanently part of your inf112.RoboRally.game.deck.
     * The Energy Routine programming card acts as an extra Power Up card in your programming inf112.RoboRally.game.deck. */
    ENERGY_ROUTINE(3),

    /** Effect: You may give your robot priority for this register. This card overrides Admin Privilege. */
    MANUAL_SORT(1),

    /** Effect: Draw three cards. Then choose three from your hand to put on top of your inf112.RoboRally.game.deck. */
    MEMORY_SWAP(1),

    /** Effect: Add the Repeat Routine programming card to your discard pile.
     * It is now permanently part of your inf112.RoboRally.game.deck.
     * The Repeat Routine programming card acts as an extra Again card in your programming inf112.RoboRally.game.deck. */
    REPEAT_ROUTINE(3),
    ...
    /** Effect: Replace each SPAM damage card in your hand with a card from the top of your inf112.RoboRally.game.deck.
     * Immediately discard the SPAM damage cards by placing them in the SPAM damage card draw pile.
     * If you draw new SPAM damage cards from your inf112.RoboRally.game.deck, keep them in your hand for this round. */
    SPAM_BLOCKER(3),

    /** Effect: Discard your entire hand. Draw a new one.
     * If you need to reshuffle your discard pile to replenish your inf112.RoboRally.game.deck, you may. */
    RECOMPILE(1),
     ...
     * It is now permanently part of your inf112.RoboRally.game.deck.
     * The Speed Routine programming card acts as an extra Move 3 card in your programming inf112.RoboRally.game.deck. */
    SPEED_ROUTINE(3),
