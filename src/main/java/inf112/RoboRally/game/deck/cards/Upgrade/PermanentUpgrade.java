package inf112.RoboRally.game.deck.cards.Upgrade;

import java.util.Arrays;
import java.util.List;

/** Once you've purchased a permanent upgrade, place it on your inf112.RoboRally.game.player mat.
...
public enum PermanentUpgrade {
     ...
     * you may give that inf112.RoboRally.game.player one worm damage card instead of one SPAM damage card. */
    ...
    /** Effect: You may discard cards from your hand and place them on the top of your inf112.RoboRally.game.deck.
     * Do not draw replacement cards. */
    CACHE_MEMORY(4),

    /** Effect: Once during each round, you may permanently discard one damage card from your hand.
     * Draw a replacement card from the top of your inf112.RoboRally.game.deck. */
    DEFRAG_GIZMO(5),

    /** Effect: Deal one additional SPAM damage card to any robot you shoot. */
    DOUBLE_BARREL_LASER(2),

    /** Effect: When you push another robot, give that inf112.RoboRally.game.player this card, and take one of
     * their installed upgrades. That inf112.RoboRally.game.player keeps this card until they use it. */
    MODULAR_CHASSIS(1),
    ...
    /** Effect: If you attack a robot, that inf112.RoboRally.game.player replaces the card in their next
     * register with the top card of their inf112.RoboRally.game.deck, unless it is the final register. */
    SCRAMBLER(3),
    ...
    /** Effect: When you push a robot, give that inf112.RoboRally.game.player a virus damage card. */
    VIRUS_MODULE(2);
