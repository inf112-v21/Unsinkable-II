...
public enum PermanentUpgrade {
     ...
     * you may give that player one worm damage card instead of one SPAM damage card. */
    ...
    /** Effect: When you push another robot, give that player this card, and take one of
     * their installed upgrades. That player keeps this card until they use it. */
    MODULAR_CHASSIS(1),
    ...
    /** Effect: If you attack a robot, that player replaces the card in their next
     * register with the top card of their deck, unless it is the final register. */
    SCRAMBLER(3),
